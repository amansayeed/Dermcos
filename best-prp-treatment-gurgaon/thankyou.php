...
if(isset($_POST['submit']))
 { $name = $_POST['name']; 
   ...
   $headers = "From: Dermcos;\r\nContent-Type: text/html;\r\n charset=ISO-8859-1;";
   
 
  
   $mailSend = mail('onlinemess2018@gmail.com','Get a Treatment Advice.', $msg, $headers);
   ...
   if($mailSend){
	...
	header("Location:asas.html");
       	echo"<p style='colo:red;'>"."not successful"."</p>";
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/798ab533d3e4725edfbed7f84/images/9d515b2f-80e1-4d35-82c2-e017fc32b1cc.png" width="185" style="max-width:185px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h2 style="text-align: center;"><span style="color:#A52A2A"><span style="font-size:60px">Thank you.</span></span></h2>

<p style="font-size: 18px !important; text-align: center;"><span style="font-size:24px">&nbsp;You Submission is received and we will contact you Soon...</span></p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Back to Home" href="http://www.dermcosskincare.com" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Back to Home</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
