...
session_start();
//include_once("admin/include/common.php");
include_once("../admin/include/session.php");

?>
<?php
		
	
	$Name = ReplaceEmpty("name","");
	$Email = ReplaceEmpty("email","");
	$Mobile = ReplaceEmpty("mobile","");
   $Message = ReplaceEmpty("query","");
...
&nbsp;
    ...
    <tbody><tr>
		...
		$Message1 = "Your appointment has been booked at Dermcos skin care clinic.";
				
		$from = "info@dermcosskincare.com";  ///change this email from reference mail id
	
		echo SendMail($HTML,$from,$Email,$Message1);   ///customer email function
		
			
			
				 $AdminHTML = "<table width=\"600\" border=\"2\" style=\"font-color:#000000; background-color:white; font-family:Arial; height:630px; margin:0 auto; font-size:14px; \">
<tr>
  <td><table border=\"0\">
    <tr>
        <td width=\"392\" colspan='2'><img src=\"http://www.dermcosskincare.com/images/logo.png\" width=\"191\" height=\"114\" border=\"0\" style=\"margin-left:20px; margin:5px;\" /></td>
...
<tr>
  <td><table width=\"500\" border=\"0\">
    <tr>
      <td><table width=\"623\" border=\"0\" style=\"  margin-left:38px;\">
        <tr>
          <td style=\"font-size:18px; font-family:Arial; \" colspan=2><strong>You have an appointment request. The details are following:</strong></td>
            </tr>
		<tr>
    <td width=\"120\"></td>
    <td></td>
...
<tr>
  <table style=\"text-align:center; text-align:justify;  height:auto; float:left; color:black; font-family:Arial; font-weight:bold; margin-left:38px;font-size:14px;\" >
      <tr>
          <td height=\"31\">Yours sincerely, </td>
        </tr>
        <tr>
          <td>Dermcos Skin Care </td>
        </tr>
		  <tr>
          <td>SCO-58, Old Judicial Complex, Near ICICI Bank ,</td>
        </tr>
		  <tr>
          <td>Civil lines, Sec-15,  </td>
        </tr>
		<tr>
		<td>
		Gurgaon Haryana 122001
		 ...
		 <tr>
          <td>Phone +91-9910124566</td>
        </tr>
		 <tr>
          <td>Email info@dermcosskincare.com </td>
        </tr>

</table>";

			$AdminEmail1 = "gautamnaresh96@gmail.com";
			//$AdminEmail1 = "info@dermcosskincare.com,abhash@ichelon.in";  ///change with admin email id
			$MessageAdmin = "You have an appointment request- ";
			$from = "info@dermcosskincare.com";  
			SendMail($AdminHTML,$from,$AdminEmail1,$MessageAdmin);
			SetMsg("We appreciate Your Interest.We will contact you soon.","success");
			;
                        ?>
...
{
	 echo $_SESSION['msg']="All Fields are mandatory";
