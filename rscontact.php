...
?>  
	...
	<!-- Main Container Starts -->
		<div class="container main-container text-center-sm text-center-xs text-center"  >
			<h1 >Contact Us</h1>
			<div class="row">
			<!-- Address Starts -->
...
<div class="controls">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<label for="form_lastname">Mobile*</label>
				<input id="form_lastname" type="text" name="mobile" class="form-control" placeholder="Please enter your Mobile Number *" required="required" data-error="Lastname is required.">
				<div class="help-block with-errors"></div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input name="date" class="dateofapp form-control" type="date" required="required" />
   </div>
				<div class="help-block with-errors"></div>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-12">
			<input type="submit" name="submit" value="Send" class="btn btn-success btn-send">
		</div>
	</div>
